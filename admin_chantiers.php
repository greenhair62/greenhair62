...
$statement_chantiers = $pdo->prepare('SELECT * FROM chantiers ');
$statement_chantiers->execute();
$articles = $statement_chantiers->fetchAll();
$categories = [];
...
<head>
    ...
    <link rel="stylesheet" href="/public/CSS/admin_chantiers.css">
...
<body>
    <div class="container">
        <h1>ADMINISTRATEUR VOS CHANTIERS</h1>
        <div class="main-category-container">
            <ul class="category-container">
                <div class="content">
                    <li class="fz"><a href="/admin_.php">TOUS VOS CHANTIERS<span class="small">(<?= count($articles) ?>)</span></a></li>
                    <?php foreach ($cat as $cKey => $cNum) :  ?>
                        <li class="fz"><a href="admin_displayCat.php/?cat=<?= $cKey ?>"><?= $cKey ?><span class="small">(<?= $cNum ?>)</span></a></li>
                    <?php endforeach; ?>
                </div>
            </ul>
...
<!-- <div class="action">
                <a class="btn btn-primary" href="/admin_delete_chantiers?id=<?= $article['id'] ?>">Delete</a>
                <a class="btn btn-primary" href="/admin_ajouter_chantiers.php?id=<?= $article['id'] ?>">Edit</a>
            </div> -->
